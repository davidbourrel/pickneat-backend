...
async function main() {
  ...
  const getCategoryId = (index: number) => createdCategories[index].id;
  ...
  const products = [
    {
      ...
      categoryId: getCategoryId(0), // Burgers
      imageUrl:
    ...
    },
    {
      ...
      categoryId: getCategoryId(1), // Desserts
      imageUrl:
    ...
    },
    {
      ...
      categoryId: getCategoryId(1), // Drinks
      imageUrl:
    ...
    },
    {
      ...
      price: new Prisma.Decimal(4.0),
      categoryId: getCategoryId(2), // Salads
      imageUrl:
    ...
    },
    {
      ...
      price: new Prisma.Decimal(4.0),
      categoryId: getCategoryId(3), // Sides
      imageUrl:
